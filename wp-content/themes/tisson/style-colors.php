...
/* Faq & Accordion & Tabs */
	.accordion .question h5,.faq .question h5 {
		...
		background: <?php mfn_opts_show( 'background-accordion-title', '#2c3e50' ) ?>;
	...
	.accordion .answer, .faq .answer {
		background: <?php mfn_opts_show( 'background-accordion-text', '#dfe3e5' ) ?>;
		color: <?php mfn_opts_show( 'color-accordion-text', '#1F1B1B' ) ?>;
	}
